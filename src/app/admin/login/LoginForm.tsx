...
/**
 * 매직링크 입력 폼. 서버 페이지(page.tsx)가 runtime='edge' 를 선언하고
 * 이 클라이언트 컴포넌트를 렌더한다 — Cloudflare Pages 의 "모든 비-static
 * 라우트에 edge runtime 선언" 요구사항을 충족.
 *
 * ADMIN_EMAILS 화이트리스트 검사는 middleware/route 핸들러에서 수행 —
 * 이 폼은 누구나 매직링크 발송을 시도할 수 있다. 하지만 admin 이 아니면
